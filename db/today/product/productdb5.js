...
function creatdb(mongoose){
    ...
    var newCategory = new todayCategory({pid:81
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID81_URL
        ,time:0
        ,gallery:macroproduct.PID81_GALLERY
    });
    ...
    var newCategory = new todayCategory({pid:82
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID82_URL
        ,time:0
        ,gallery:macroproduct.PID82_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:83
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID83_URL
        ,time:0
        ,gallery:macroproduct.PID83_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:84
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID84_URL
        ,time:0
        ,gallery:macroproduct.PID84_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:85
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID85_URL
        ,time:0
        ,gallery:macroproduct.PID85_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:86
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID86_URL
        ,time:0
        ,gallery:macroproduct.PID86_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:87
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID87_URL
        ,time:0
        ,gallery:macroproduct.PID87_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:88
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID88_URL
        ,time:0
        ,gallery:macroproduct.PID88_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:89
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID89_URL
        ,time:0
        ,gallery:macroproduct.PID89_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:90
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID90_URL
        ,time:0
        ,gallery:macroproduct.PID90_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:91
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID91_URL
        ,time:0
        ,gallery:macroproduct.PID91_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:92
        ...
        ,time:0
        ,gallery:macroproduct.PID92_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:93
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID93_URL
        ,time:0
        ,gallery:macroproduct.PID93_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:94
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID94_URL
        ,time:0
        ,gallery:macroproduct.PID94_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:95
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID95_URL
        ,time:0
        ,gallery:macroproduct.PID95_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:96
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID96_URL
        ,time:0
        ,gallery:macroproduct.PID96_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:97
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID97_URL
        ,time:0
        ,gallery:macroproduct.PID97_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:98
        ...
        ,time:0
        ,gallery:macroproduct.PID98_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:99
        ...
        ,state:1
        ,stamper:''
        ,pic_url:macroproduct.PID99_URL
        ,time:0
        ,gallery:macroproduct.PID99_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
    ...
    var newCategory = new todayCategory({pid:100
        ...
        ,time:0
        ,gallery:macroproduct.PID100_GALLERY
    });
    newCategory.save( function( err, silence ) {
        if( err )
        {
