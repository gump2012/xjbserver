...
function createdb(mongoose){
    ...
    var newCategory = new todayCategory({cid:1
        ...
        ,pic_url:'http://pic.yupoo.com/yige2002/DMTH3JYl/qBW7D.png'});
    ...
    newCategory = new todayCategory({cid:2
        ...
        ,pic_url:'http://pic.yupoo.com/yige2002/DMTH4zZE/SYLet.png'});
    newCategory.save( function( err, silence ) {
        if( err )
        {
            console.log(err);
    ...
    newCategory = new todayCategory({cid:3
        ...
        ,pic_url:'http://pic.yupoo.com/yige2002/DMTGWAMe/GPwRm.png'});
    newCategory.save( function( err, silence ) {
        if( err )
        {
            console.log(err);
    ...
    newCategory = new todayCategory({cid:4
        ...
        ,pic_url:'http://pic.yupoo.com/yige2002/DMTGWISY/GvUbJ.png'});
    newCategory.save( function( err, silence ) {
        if( err )
        {
            console.log(err);
    ...
    newCategory = new todayCategory({cid:5
        ...
        ,pic_url:'http://pic.yupoo.com/yige2002/DMTH4wpK/7dVXL.png'});
    newCategory.save( function( err, silence ) {
        if( err )
        {
            console.log(err);
    ...
    newCategory = new todayCategory({cid:6
        , cname:'两性游戏'
        ,info:'花前月下，你侬我侬'
        ,pic_url:'http://pic.yupoo.com/yige2002/DMTGVbLL/rUCQj.png'});
    newCategory.save( function( err, silence ) {
        if( err )
        {
            console.log(err);
